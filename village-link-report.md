...
Checked **666** URLs: **643** OK, **18** HTTP errors, **0** redirects, **5** unreachable/timeouts.
...
- `https://courses.wildhomesteadliving.com/homesteading-made-simple-landing`  (error: URLError)
