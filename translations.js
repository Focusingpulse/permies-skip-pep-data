...
const LANG = {
  ...
  "ui": {
    ...
    "Not a screen game — build real skills, grow real attributes, earn real badges in the real world.": "No es un juego de pantalla: construye habilidades reales, desarrolla atributos reales y gana insignias reales en el mundo real.",
