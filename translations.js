...
const LANG = {
  ...
  "ui": {
    ...
    "Quests": "Misiones",
    "Lab": "Lab",
    "The Quest Lab": "El Lab de Misiones",
    "Quest cards from the knowledge fleet — buildable, testable family experiments. A quest card is a TEST of a claim, not an endorsement. Proposed cards appear here before merging into the Quest Board.": "Cartas de misión de la flota de conocimiento — experimentos familiares construibles y comprobables. Una carta de misión es una PRUEBA de una afirmación, no un respaldo. Las cartas propuestas aparecen aquí antes de fusionarse con el Tablero de Misiones.",
    "What to do": "Qué hacer",
    "Passes when": "Aprobada cuando",
    "Proposed": "Propuesta",
    "Merged": "Fusionada",
    "From the Vault": "Del Archivo",
    "Source": "Fuente",
    "Grows daily with the knowledge fleet": "Crece a diario con la flota de conocimiento",
    "Schoolhouse": "Escuela",
    "Library": "Biblioteca",
    ...
    "Metalworking": "Trabajo en Metal",
    "Textiles & Natural Dye": "Textiles y Tintes Naturales",
  ...
  "ui": {
    ...
    "Quests": "Quêtes",
    "Lab": "Labo",
    "The Quest Lab": "Le Labo de Quêtes",
    "Quest cards from the knowledge fleet — buildable, testable family experiments. A quest card is a TEST of a claim, not an endorsement. Proposed cards appear here before merging into the Quest Board.": "Cartes de quête de la flotte de savoir — des expériences familiales à construire et à tester. Une carte de quête est un TEST d'une affirmation, pas une approbation. Les cartes proposées apparaissent ici avant d'être fusionnées dans le Tableau des Quêtes.",
    "What to do": "À faire",
    "Passes when": "Réussie quand",
    "Proposed": "Proposée",
    "Merged": "Fusionnée",
    "From the Vault": "Depuis l'Archive",
    "Source": "Source",
    "Grows daily with the knowledge fleet": "Grandit chaque jour avec la flotte de savoir",
    "Schoolhouse": "École",
    ...
    "Textiles & Natural Dye": "Textiles et Teinture Naturelle",
  ...
  "de": {
    ...
    "No expressions recorded yet. Add one with \"+ Add one\" on any element.": "Noch keine Ausdrücke erfasst. Füge einen mit „+ Hinzufügen“ bei einem beliebigen Element hinzu.",
      ...
      "Quests": "Aufgaben",
      "Lab": "Labor",
      "The Quest Lab": "Das Aufgaben-Labor",
      "Quest cards from the knowledge fleet — buildable, testable family experiments. A quest card is a TEST of a claim, not an endorsement. Proposed cards appear here before merging into the Quest Board.": "Quest-Karten aus der Wissensflotte — nachbaubare, überprüfbare Familienexperimente. Eine Quest-Karte ist ein TEST einer Behauptung, keine Befürwortung. Vorgeschlagene Karten erscheinen hier, bevor sie in das Quest-Brett übernommen werden.",
      "What to do": "Was zu tun ist",
      "Passes when": "Bestanden, wenn",
      "Proposed": "Vorgeschlagen",
      "Merged": "Übernommen",
      "From the Vault": "Aus dem Archiv",
      "Source": "Quelle",
      "Grows daily with the knowledge fleet": "Wächst täglich mit der Wissensflotte",
    ...
    "Textiles & Natural Dye": "Textilien & Naturfarben",
