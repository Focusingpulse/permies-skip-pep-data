...
const CURRICULA = [
  {
    ...
    evidence_depth: [
      ...
      { source: "Dohrmann, Nishida, Gartner, Lipsky & Grimm, 'High School Outcomes for Students in a Public Montessori Program', Journal of Research in Childhood Education (2007)", claim: "Matched longitudinal study of Milwaukee Public Schools graduates (1997–2001) who attended Montessori preschool–5th grade: significantly higher on a math/science factor, no significant difference in English/social studies or GPA. The honest read — a real but narrow advantage, and the design is observational, not a lottery.", medium: "longitudinal matched-cohort study", confidence: "Moderate", year: "2007" },
      { source: "Association Montessori Internationale (AMI) — founded 1929 by Maria and Mario Montessori at the first International Montessori Congress (Helsingør/Kronborg, Denmark; 1,800+ delegates from 43 countries); Montessori's first training course, Città di Castello, 1909 (~100 students); AMI today: 64 teacher-training centres in 32 countries. Sources: montessori-ami.org timeline + archives.montessori-ami.org", claim: "Teacher-training lineage: Montessori's method was carried by a single certifying body she founded herself, with a fixed training course and licensed trainers — one of the oldest continuously standardised teacher-training lineages in education (1909→today), and the reason 'Montessori' names something specific rather than a loose label.", medium: "teacher-training lineage", confidence: "High (as training lineage), none claimed (as outcome evidence)", year: "1909–today" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "Douglas Gabriel, Spirit of Childhood; The Eternal Curriculum for Wisdom Children (eternalcurriculum.com, free PDFs) + his Waldorf teacher-training lectures", claim: "Teacher-training materials: a Waldorf teacher-trainer's own curriculum books and lecture series built to make Steiner's pedagogy usable by homeschooling parents — the 'how to actually teach it' layer that sits between Steiner's lectures and a family's week.", medium: "teacher-training materials", confidence: "High (as teacher training), none claimed (as outcome evidence)", year: "2017–today" },
      { source: "The first Waldorf school, Freie Waldorfschule Stuttgart — founded 1919 for the children of workers at the Waldorf-Astoria cigarette factory at the request of its director Emil Molt; Rudolf Steiner led the pedagogy and personally trained the first faculty in a two-week intensive course (21 Aug – 6 Sept 1919) before the school opened on 7 Sept 1919 with 12 teachers and 56 pupils. Three courses from that training remain the foundational texts of Waldorf teacher education: Study of Man (GA 293), Practical Advice to Teachers (GA 294) and Discussions with Teachers (GA 295). After Steiner's death in 1925 the trained teachers carried the training themselves; the first two training centres were the Freie Hochschule Stuttgart – Seminar für Waldorfpädagogik (1928) and a centre at the Goetheanum in Dornach, Switzerland (1957), the Anthroposophical Society's headquarters, whose Pedagogical Section still convenes the World Waldorf Teachers' Conference every four years. Sources: anthroposophie.ch, 'Founding of the first Waldorf school'; anthroposophicpress.org (Discussions with Teachers, CW 295); Waldorf teacher-education history, Encounters in Theory and History of Education (Queen's University)", claim: "Teacher-training lineage: Waldorf's method was transmitted by a founder who trained his own faculty in person, then by that faculty training their successors — a closed teaching lineage with its own foundational course texts, its own training centres from 1928, and a standing international teachers' conference. That is why 'Waldorf' names a specific pedagogy rather than a general sympathy with arts and rhythm. The honest read: this documents transmission fidelity, not outcomes.", medium: "teacher-training lineage", confidence: "High (as training lineage), none claimed (as outcome evidence)", year: "1919–today" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "HeartMath Institute research + teacher-training programs", claim: "Heart-brain coherence techniques (Heart Focus, Freeze-Frame) improve emotional self-regulation, focus and stress resilience in students — the inner skill that makes self-direction sustainable.", medium: "practitioner documentation / benchmark study", confidence: "Moderate-strong (inner skill)", year: "1990s–today" },
      { source: "HeartMath Institute — institutional timeline and 2024 annual report (heartmath.org/about-us): founded 1991 by Doc Childre; research centre and scientific advisory board 1992; first paper in the American Journal of Cardiology 1995; HeartMath LLC spun off 1998 for product development and distribution; a 2004 U.S. Department of Education grant of $1M tested the techniques against test anxiety; 2024 revenue $4.06M against $3.80M expenses, with 51% to education programmes and 32% to research, and fundraising and management paid for out of product and training sales.", claim: "Practitioner documentation with a financial receipt: the same organisation both runs the research and sells the training, and its own annual report shows the research is funded by those sales — which is why the peer-reviewed HRV findings and the product claims must be read as related but distinct. The 2004 federal education grant is the strongest external check on the student-facing claim, and it is a grant, not a published outcome trial.", medium: "practitioner documentation (institutional record)", confidence: "High (as institutional record), none claimed (as outcome evidence)", year: "1991–2024" },
      { source: "Summerhill School, Leiston, Suffolk — A.S. Neill's school (founded 1921) and the independent schools tribunal at the Royal Courts of Justice, London, March 2000. A notice of complaint issued by Education Secretary David Blunkett (July 1999, after the Ofsted report that pupils were allowed to 'mistake idleness for the exercise of personal liberty') was withdrawn after a three-day hearing, and the school dropped its appeal. The agreed statement recognised that learning is not confined to formal lessons and that attendance levels should not be the sole basis for judging education; the next full inspection was set for no earlier than 2004. Sources: The Guardian (24 Mar 2000); The Independent (24 Mar 2000); BBC News, 'Summerhill closure threat lifted'; Ofsted's statement on the outcome", claim: "Archival public record: after 79 years, this was the first official acknowledgment that a school run on voluntary lessons could be an acceptable alternative — and it forced the inspection framework to admit it had been measuring the wrong thing. The honest read: the tribunal ended in a negotiated statement, not a judicial verdict on outcomes, so it documents legitimacy and survival, not learning gains.", medium: "archival primary source (public record)", confidence: "High (as record), none claimed (as outcome evidence)", year: "2000" }
    ],
    authors: [{ name: "John Holt", work: "How Children Fail (1964); Instead of Education (1976)", point: "The founder of the modern unschooling movement — teacher turned doubter of schools." }, { name: "Peter Gray", work: "Free to Learn (2013)", point: "The research voice of self-directed education; evolutionary psychology of play." }, { name: "A.S. Neill", work: "Summerhill (1960)", point: "The original democratic free school, operating since 1921." }, { name: "HeartMath Institute", work: "heartmath.org — emWave, HeartSmarts programs", point: "Practical tools for emotional self-regulation — the inner technology that supports freedom without chaos." }],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "Association of Classical Christian Schools (ACCS, founded 1994; ~300 schools / ~50,000 students) — 'Good Soil: 7 Life Outcomes of ACCS Alumni'. ACCS commissioned the University of Notre Dame Sociology Department to run the Cardus alumni-survey instrument with ACCS alumni as a sixth school segment alongside public, secular private, Catholic, evangelical Christian and religious homeschool alumni; results reported winter 2019. classicalchristian.org/good-soil", claim: "Alumni survey: ACCS graduates reported distinct life outcomes (academic preparation, independent thought, influence) versus the comparison segments. The honest read — this is a SELF-COMMISSIONED survey by the body it evaluates, and ACCS itself notes the groups differ in ways that invite skepticism; treat it as a large practitioner-alumni survey, not an independent trial.", medium: "alumni survey (self-commissioned)", confidence: "Moderate (self-commissioned)", year: "2019" },
      { source: "The CiRCE Apprenticeship (CiRCE Institute, founded by Andrew Kern, co-author of Classical Education: The Movement Sweeping America) — begun c. 2005. A three-year mentored program: a Master Teacher guides a small group in classical rhetoric and classical modes of instruction, meeting twice yearly in person and twice monthly online. In spring of year one, apprentices decide whether to continue two more years as journeymen, who then mentor and assess the next cohort; completion confers 'CiRCE Certified Classical Teacher'. 300+ participants to date; the Apprenticeship now carries 12 credit hours toward a Master of Arts in Classical and Liberal Education with Belmont Abbey College. Sources: circeinstitute.org/apprenticeship; Kern, 'On Apprenticeship and Teacher Formation' (2023)", claim: "Teacher-training lineage: the modern classical revival is transmitted by a formal mentored apprenticeship — one master teacher, a small cohort, years of practice with feedback — not by a textbook or a degree. That is the guild's own transmission model applied to the teachers themselves, and it is why classical schools that never coordinate still share a pedagogy. Distinct from the practitioner-corpus entry above: this is the certifying lineage, not the reading list.", medium: "teacher-training lineage", confidence: "High (as training lineage), none claimed (as outcome evidence)", year: "2005–today" }
    ],
    authors: [{ name: "Plato & Aristotle", work: "The Republic; Rhetoric", point: "The original source — education as the shaping of the soul and the citizen." }, { name: "Quintilian", work: "Institutio Oratoria (c. 95 CE)", point: "The first complete classical pedagogy — the trivium codified by a Roman teacher." }, { name: "Dorothy Sayers", work: "The Lost Tools of Learning (1947)", point: "The spark of the modern classical homeschooling revival." }, { name: "Andrew Kern", work: "Classical Education: The Movement Sweeping America (with Gene Edward Veith); The CiRCE Guide to Reading; the CiRCE Apprenticeship", point: "Founder and president of the CiRCE Institute; researching, teaching and training teachers in the Christian classical renewal since 1993, and the teacher-trainer behind the modern revival's mentored apprenticeship model." }],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "The Parents' Review — monthly magazine of the Parents' National Educational Union (PNEU), 1890–1966 (vols. 1–77); digitised in the Charlotte Mason Digital Collection (Redeemer University) and the Internet Archive", claim: "Archival primary source: ~77 years of monthly issues (longer than the six volumes), written by Mason and the practising teachers of the Parents' Union School — a continuous record of the method in daily use, with its own failures and revisions recorded by the people running it.", medium: "archival primary source / practitioner documentation", confidence: "High (as record), none claimed (as outcome evidence)", year: "1890–1966" },
      { source: "Charlotte Mason's House of Education, Ambleside — opened January 1892 with four students, moved to Scale How in 1894; renamed Charlotte Mason College in 1938; recognised within the national teacher-training system from 1961; part of Lancaster University in the 1990s, then St Martin's College (2007) and the University of Cumbria; teacher training at Ambleside ended in 2010. Sources: University of Cumbria alumni history; the Armitt Museum, Ambleside; Charlotte Mason Digital Collection (Redeemer University) timeline", claim: "Teacher-training lineage: Mason built her own training institution for the governesses who would teach by her method — a two-year course she directed herself, which outlived her by nearly a century (1892–2010) and trained teachers continuously. That institutional continuity is why 'Charlotte Mason' names a specific method rather than a general sympathy with living books.", medium: "teacher-training lineage", confidence: "High (as training lineage), none claimed (as outcome evidence)", year: "1892–2010" },
      { source: "The Parents' Review School, founded June 1891 and renamed the Parents' Union School (PUS) in 1907 — Charlotte Mason's correspondence school, which posted a term-by-term curriculum ('programmes') from Ambleside to families and small schools for over forty years, spanning ages 6–18 across the full range of subjects, with end-of-term examinations and work sent back for inspection. Sources: Charlotte Mason Digital Collection (Redeemer University) timeline; the PUS Diamond Jubilee Magazine (the 1892 Term 1 Form I programme, reproduced by AmblesideOnline); 'The PNEU and Public Examinations' (charlottemasonpoetry.org)", claim: "A working distance-education system a century before the modern homeschooling movement: Mason left an operating curriculum, not just a philosophy — programmes, booklists, timetables and exams, delivered by post and revised term by term. The honest read: this is a primary-source record of a system in daily use at scale, not a controlled study of its outcomes.", medium: "archival primary source / practitioner documentation", confidence: "High (as record of practice), none claimed (as outcome evidence)", year: "1891–1930s" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "Project Zero (Harvard Graduate School of Education) & the municipal infant-toddler centres and preschools of Reggio Emilia — 'Making Learning Visible: Children as Individual and Group Learners' (2001); project begun 1997", claim: "A multi-year research collaboration, not an outside evaluation: Harvard researchers and Reggio teachers built the documentation-as-assessment framework together. It is the clearest case of a pedagogy whose central practice — making thinking visible — is itself the research method, which is why it yields rich qualitative evidence and little controlled-trial evidence.", medium: "research collaboration / practitioner documentation", confidence: "High (as method documentation)", year: "1997–2001" },
      { source: "Reggio Children s.r.l. (founded 1994) and the Loris Malaguzzi International Centre — run by Reggio Children since 2006 (first renovated section officially opened 2006, completed 2012) — together with the municipal Istituzione of Preschools and Infant-toddler Centres and the Reggio Children International Network (2006). Sources: reggiochildren.it system and history pages", claim: "Teacher-training lineage: the approach is carried by a formal institution that runs study groups, ateliers and multi-day professional-development journeys led by practising teachers, pedagogistas and atelieristas from the municipal schools, plus an international network of partner countries. The method is transmitted by apprenticeship inside working schools, not by a textbook — which is why its evidence is documentation rather than trials.", medium: "teacher-training lineage", confidence: "High (as training lineage), none claimed (as outcome evidence)", year: "1994–today" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "Jon Young's mentoring lineage — mentored from age 10 (met 1971) by tracker and author Tom Brown Jr., who was himself mentored by the Apache scout Stalking Wolf ('Grandfather'); Jon was among the first instructors at the Tracker School when it opened in 1978; he co-founded the Wilderness Awareness School in Monmouth County, NJ in 1983, joined in 1984 by the Akamba elder M. Norman Powell ('Ingwe', b. 1914, raised among the Akamba in Kenya), later based in Duvall, WA. The mentoring system built there became '8 Shields Cultural Mentoring'. The Art of Mentoring was first run as adult training in 1992, first offered publicly in 1995, and has since run in the US, Canada, Germany, Austria, Switzerland, Italy, UK, Ireland, Poland, Sweden, France, Spain, Australia, New Zealand, South Africa and Botswana. The 8 Shields Institute (formed c.2010) carried the work on and passed it to the Nature Connection Mentoring Foundation (c.2017); the Institute itself disbanded in 2020, and the lineage continues through the Foundation and the practitioners it trained. Sources: jonyoung.org/about-me; wildernessawareness.org/about; 8shields.org/origins; birdlanguage.com author page", claim: "Teacher-training lineage plus oral tradition: Coyote Mentoring is not a curriculum someone wrote — it is a mentoring method passed hand to hand (Stalking Wolf → Tom Brown Jr. → Jon Young) and then deliberately made transferable through a training programme (Art of Mentoring, 1992→) that has seeded nature-connection programmes on four continents. The lineage itself is the evidence: the method's claim is that it was *transmitted* across generations, not that it was tested. (The school's own figure of 100+ influenced programmes is self-reported.)", medium: "teacher-training lineage / oral tradition", confidence: "High (as lineage and training), none claimed (as outcome evidence)", year: "1971–today" },
      { source: "8 Shields origins account, 8shields.org/origins (the network's own history page) — the founding group from 1983 was Jon Young, the South African elder M. Norman Powell ('Ingwe', b. 1914 in the rural Western Cape, raised in Kenya among the Akamba and San Bushman grandmothers, d. 2005 aged 92) and staff and volunteers at the Wilderness Awareness School, Monmouth County, NJ. Ingwe chose the word 'shields' over 'curriculum' deliberately, on the grounds that a curriculum is not holistic or many-layered enough to carry what had to be passed on through camps, youth programmes, workshops and mentoring. The model began as Six Shields (the four directions plus earth and sky, organised on X/Y/Z axes) and became Eight about twenty years later at the urging of Jenn Wolfe, when the Northwest and Southeast were added and crowd-sourced across North America, Europe and Hawai'i. Kamana Naturalist Training was published in 1995; Coyote's Guide to Connecting with Nature in 2007.", claim: "Oral tradition / practitioner documentation: the 8 Shields is not a curriculum written by an author but a set of principles deliberately crowd-sourced and universalised — the founders explicitly refused to appropriate any single culture, deriving the pattern from direct observation of nature, from children's and teens' own reports at the four directions, and from Ingwe's Bushman and Akamba upbringing. The naming decision is the honest tell: 'shields' rather than 'curriculum', because what is transmitted is a set of practices and roles, not a syllabus. This documents how the method was formed and carried, not what it produces.", medium: "oral tradition / practitioner documentation", confidence: "High (as lineage account), none claimed (as outcome evidence)", year: "1983–today" },
      { source: "Forest School Association (FSA, UK professional body) — Level 3 Certificate for Forest School Leaders, an Ofqual-regulated qualification (e.g. QNUK 603/7784/7; AIM 603/2926/9) placed on the Regulated Qualifications Framework in 2018: 180 hours total qualification time, 96 guided learning hours, 18 credits, five mandatory units (woodland environment; learning and development; practical skills; planning and preparation; delivery), assessed by portfolio of evidence. forestschoolassociation.org/forest-school-qualification", claim: "Teacher-training framework: Forest School's method is defined by a regulated national leader qualification — a fixed curriculum, a supervised practical placement, and a recognised-provider register — rather than by individual enthusiasm. That is why 'Forest School' has a shared, inspectable meaning across the UK, and why the FSA refuses purely online Level 3 courses for its recognised-provider scheme.", medium: "teacher-training qualification framework", confidence: "High (as training standard), none claimed (as outcome evidence)", year: "2018–today" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "UNESCO, 'Tradition of Vedic chanting' — Representative List of the Intangible Cultural Heritage of Humanity (proclaimed 2003, inscribed 2008); ich.unesco.org/en/RL/tradition-of-vedic-chanting-00062", claim: "The Vedas were carried orally, not as books: preservation across ~3,500 years rested on recitation techniques taught from childhood — tonal accent, a fixed manner of pronouncing each letter, specific speech combinations. UNESCO's own assessment is the honest edge: only 13 of over 1,000 recitation branches survive, four schools under imminent threat. The method is documented in this detail precisely because it is endangered.", medium: "oral tradition (UNESCO ICH documentation)", confidence: "High (as documentation), none claimed (as outcome evidence)", year: "2003/2008" },
      { source: "The Baudhayana Sulbasutra (c. 800 BCE) and the wider Sulbasutra corpus — the oldest surviving applied-geometry text, compiled from oral knowledge that may reach back to 2000 BCE. The texts state the rule now called the Pythagorean theorem ('the diagonal of an oblong produces by itself both the areas which the two sides produce separately'), and Baudhayana i.61–2 gives the diagonal of a square as 1 + 1/3 + 1/(3·4) − 1/(3·4·34) = 577/408 ≈ 1.414216 — correct to five decimals. Sources: Baudhayana Sulbasutra (trans. Thibaut); MacTutor History of Mathematics, 'Indian Sulbasutras'; D. Henderson, 'Square Roots in the Sulbasutra' (Cornell); Plofker, Mathematics in India (2009)", claim: "Archival primary source: the gurukul tradition's mathematics was precise enough to state the Pythagorean relation and compute √2 to five decimal places — and it did so to lay out fire altars, not to publish theorems. The honest edge: Baudhayana gives the rule with a special case, the general statement appears in the later Apastamba and Katyayana Sulbasutras, and the written texts compile older oral knowledge — so 'who knew it first' is genuinely uncertain, but the text itself is the receipt.", medium: "archival primary source", confidence: "High (as historical record), none claimed (as outcome evidence)", year: "c. 800 BCE" },
      { source: "The guru-shishya parampara — the teacher-to-student transmission institution of the gurukula, documented in the Sanskrit sutra literature and in the surviving Vedic recitation traditions. A student was admitted by the upanayana initiation (around age 5–6) and lived with the teacher for roughly twelve years, learning one field in depth; the pedagogy was three-staged — śravaṇa (attentive listening to the teacher's recitation), manana (reflection and internalisation) and nididhyāsana (sustained contemplative realisation). Writing was distrusted for the Veda: Sayana's commentary insists the text 'is to be learned from the lips of the teacher and not from a manuscript', and al-Bīrūnī reported in the 11th century that the Veda was not allowed to be written down. The lineage is still live and still shrinking: Kerala's Sama Veda tradition was carried by 21 Namboothiri families and is now continued by only a handful, with one institution (Brahmaswom Madham Veda Pathasala, Thrissur) teaching it. Sources: 'Education in Ancient India' (Handbook of Oriental Studies); Shah, 'Revisiting Vedic Pedagogies' (2024); Kerala Sama/Rg Veda oral-tradition studies (IOSR-JRME; SSUS Kalady)", claim: "Teacher-training lineage: the gurukula is not a school with a syllabus but a transmission chain — knowledge passes person to person, verified by correct recitation, and the teacher is the curriculum. Its claim is continuity across generations, and the honest edge is that the chain is breaking: UNESCO counts only 13 of 1,000+ recitation branches surviving, and the Kerala families that kept Sama Veda alive are down to a handful. This documents how the method was carried and how close it came to being lost — not what it produced.", medium: "teacher-training lineage / oral tradition", confidence: "High (as lineage and documentation), none claimed (as outcome evidence)", year: "c. 1500 BCE – today" }
    ],
  ...
  },
  {
    ...
    evidence_depth: [
      ...
      { source: "The 72-hour Permaculture Design Course (PDC) curriculum established by Bill Mollison — still the international standard, taught in the founders' lineage since the early 1980s, based on Permaculture: A Designers' Manual", claim: "Teacher-training lineage: a single fixed 72-hour curriculum carried to 130+ countries since the early 1980s, with graduates licensed to teach — one of the most standardised practitioner-training lineages in the alternative-systems world, and the reason permaculture design has a shared vocabulary across continents.", medium: "teacher-training lineage (PDC)", confidence: "High (as training lineage), moderate (as outcome evidence)", year: "1980s–today" },
      { source: "Masanobu Fukuoka (1913–2008), natural farming ('do-nothing farming') — The One-Straw Revolution (Japanese 1975; English translation, Rodale Press, 1978; 20+ languages, over a million copies). Sources: f-masanobu.jp (Masanobu Fukuoka Natural Farm); The One-Straw Revolution (archive.org)", claim: "Practitioner documentation, parallel lineage: Fukuoka farmed no-till, no-fertiliser, no-pesticide, minimal-weeding rice and citrus on Shikoku for decades before publishing, and his four principles and seed-pellet re-vegetation work influenced permaculture's founders. An independent Japanese lineage arriving at 'work with the system, not on it' from an entirely different direction — the strongest single piece of non-Western practitioner documentation behind the permaculture curriculum.", medium: "practitioner documentation", confidence: "High (practice lineage), none claimed (as outcome evidence)", year: "1947–2008" },
      { source: "Sepp Holzer (b. 1942), Austrian mountain farmer — Krameterhof, on the southern slope of the Schwarzenberg in Salzburg's Lungau ('Austria's mini Siberia'): ~45 hectares rising from 1,100 m to 1,500 m, taken over from his parents in 1962 at age 19. He built terraces, ponds, an alternative tree nursery, fish and wild-cattle breeding, mushroom and herb cultivation and agroforestry on slopes the region considered unsuitable for conventional farming. He came to the word 'permaculture' only in 1995, when students and professors from Vienna's University of Natural Resources and Life Sciences (BOKU) visited and judged the farm an example of it; he then read Mollison and Holmgren and developed it deliberately. He handed Krameterhof to his son Josef in 2009 and has trained practitioners there since 2009. Sources: krameterhof.at (farm and 'why Holzer permaculture' pages); seppholzer.at", claim: "Practitioner documentation, independent lineage: Holzer farmed this way for over thirty years before he had a name for it — the method was derived from observation on one hard farm, not from a theory applied to it. That is the opposite direction of transmission from the PDC lineage above: one is a fixed curriculum carried to 130+ countries, the other is a single site's empirical practice the academy later recognised. Both belong in the record; neither is outcome evidence.", medium: "practitioner documentation", confidence: "High (practice lineage), none claimed (as outcome evidence)", year: "1962–today" }
    ],
    authors: [{ name: "Bill Mollison & David Holmgren", work: "Permaculture One (1978); Designers' Manual (1988)", point: "The founders — design science for permanent agriculture." }, { name: "Paul Wheaton", work: "Permies.com badge system", point: "The real-world badge (PEP/SKIP) system The Creative Village adapts." }, { name: "Sepp Holzer", work: "Permaculture: A Practical Guide for Farmers, Smallholders and Gardeners (2004); Desert or Paradise (2012); Krameterhof", point: "The mountain-farmer's voice — a working 45-hectare alpine farm built by observation over decades, arriving at permaculture from practice rather than from the PDC curriculum." }, { name: "Collins, Brown & Newman", work: "Cognitive Apprenticeship (1989)", point: "The research articulation of learn-by-doing-with-a-master." }],
...
const NATURE_RHYTHM = {
  ...
  evidence_depth: [
    { source: "The Coyote Mentoring lineage — Stalking Wolf (Apache scout) → Tom Brown Jr. (Tracker School, opened 1978) → Jon Young (met Brown in 1971 at age 10; co-founded the Wilderness Awareness School in Monmouth County, NJ, 1983; later Duvall, WA). The method was made transferable through the Art of Mentoring (first run as adult training 1992, first public offering 1995) and has since run in the US, Canada, Germany, Austria, Switzerland, Italy, UK, Ireland, Poland, Sweden, France, Spain, Australia, New Zealand, South Africa and Botswana. Sources: jonyoung.org/about-me; wildernessawareness.org/about; 8shields.org/origins", claim: "Oral tradition / teacher-training lineage: the nature-connection rhythm in this panel is not a syllabus someone wrote — it is a mentoring method passed hand to hand across three named generations and then deliberately made teachable. That is why this section's evidence lives in its practitioners: the claim is that the method was transmitted and kept working, not that it was tested. The lineage documents transmission fidelity; it makes no outcome claim.", medium: "oral tradition / teacher-training lineage", confidence: "High (as lineage), none claimed (as outcome evidence)", year: "1971–today" },
    { source: "8 Shields origins account (8shields.org/origins) — the founders chose the word 'shields' over 'curriculum' deliberately, on the grounds that a curriculum is not many-layered enough to carry what had to pass through camps, youth programmes, workshops and mentoring; the model began as Six Shields on X/Y/Z axes and became Eight about twenty years later at Jenn Wolfe's urging, when the Northwest and Southeast were added and crowd-sourced across North America, Europe and Hawai'i. Kamana Naturalist Training published 1995; Coyote's Guide to Connecting with Nature 2007.", claim: "Practitioner documentation: the daily/weekly/seasonal rhythm and the mentoring principles above come from a tradition that explicitly refused to be a fixed curriculum — the pattern was derived from observation and from children's and teens' own reports, then universalised rather than tied to one culture. The honest read: this documents how the rhythm was formed and carried, not what it produces.", medium: "practitioner documentation", confidence: "High (as lineage account), none claimed (as outcome evidence)", year: "1983–today" }
  ]
};
...
const HEART_PRACTICE = {
  ...
  evidence_depth: [
    ...
    { source: "HeartMath Institute — founded 1991 by Doc Childre as a nonprofit research and education organization; the for-profit HeartMath LLC (Boulder Creek, CA) is its spinoff, translating the Institute's findings into tools and certification programmes. HeartMath reports 80+ peer-reviewed studies and 12,000+ certified practitioners worldwide; the applied research lab (with Mike Atkinson) began in the early 1990s and the first intervention study (1993) was with 38 people living with HIV. Sources: heartmath.com/about; McCraty, 'Following the Rhythm of the Heart: HeartMath Institute's Path to HRV Biofeedback', Applied Psychophysiology and Biofeedback (2022)", claim: "Practitioner and training lineage: HeartMath is a research institute plus a certification pipeline — the technique reaches families through trained coaches and trainers, and the research arm is structurally separate from the sales arm. That separation is the honest reading: the peer-reviewed HRV work and the device marketing are different products from the same organisation, and the certification count measures adoption, not efficacy.", medium: "practitioner documentation / teacher-training lineage", confidence: "High (as lineage and training), none claimed (as outcome evidence)", year: "1991–today" }
  ]
};
...
const SIX_EXERCISES = {
  ...
  gilbert: "Dr. Robert Gilbert (Vesica Institute, Las Vegas NV) teaches these as the practical foundation of Rosicrucian inner work — before energy work or meditation — framing them as the ethical and attentional base of all authentic development. His long lectures (YouTube @TheVesicaInstitute) expand each exercise in depth; transcribing them is a standing research task we will grow into. Sources: vesica.org; youtube.com/@TheVesicaInstitute.",
  evidence_depth: [
    { source: "Robert Gilbert interview, Know Thyself podcast with André Duqum (Jan 2024), chapter 'The 6 Essential Rosicrucian Exercises' at 1:03:50 — youtube.com/watch?v=6H5LuML6r8c (2.3M views)", claim: "Gilbert's key framing: 'basic' does NOT mean elementary — the six are foundational for all higher work, which is why his course calls them the 'essential' exercises. He teaches them as self-observation plus conscious direction of thinking, feeling, and willing: every thought/emotion/action is 'a cause set in motion' that structures the subtle body through repetition — so the exercises are deliberate entraining of the three centers toward balance, and the positivity exercise specifically trains 'an unbreakable positivity toward all of our life activities' as an initiation practice, not naive optimism.", medium: "teacher's own oral teaching (public video interview)", confidence: "High (as lineage teaching), none claimed (as outcome evidence)", year: "2024" },
    { source: "Rudolf Steiner, Guidance in Esoteric Training / Knowledge of Higher Worlds (pub. 1900s); oral transmission in the Rosicrucian lineage", claim: "The six exercises originate with Steiner's written instructions and were carried and expanded by teacher-practitioners (Gilbert among them) — a century-plus of practitioner documentation in the Western esoteric tradition, not a laboratory subject.", medium: "practitioner documentation / oral tradition", confidence: "High (practice lineage)", year: "1900s–today" },
    { source: "The Vesica Institute for Holistic Studies (Robert J. Gilbert, Ph.D.) — vesica.org; mailing address 6545 S. Fort Apache Rd., Ste. 135-124, Las Vegas, NV 89148. The Institute teaches the six exercises within a standing course sequence — 'Essential Teachings and Practices of Spiritual Science' (Spiritual Initiation and the Modern Independent Path), the three-part Vibrational Testing & Healing series, SEER (Subtle Energy Explorations & Research), and BioGeometry Foundation and Advanced Training — delivered as online courses with immediate access alongside occasional in-person retreats.", claim: "Teacher-training lineage: the six exercises reach students through a formal course structure with a named teacher, a fixed sequence and a progression, not through a book alone — the Rosicrucian inner-work practices are transmitted as a curriculum with an instructor. The honest read: this documents how the practice is taught and by whom, not that it works; and the course catalogue is also the sales catalogue, so the teaching arm and the commercial arm are the same object here.", medium: "teacher-training lineage", confidence: "High (as lineage and training), none claimed (as outcome evidence)", year: "current" }
  ]
};
...
const CONNECTION_SCIENCE = [
  ...
  },
  {
    ...
    studies: [
      ...
      { source: "Werner & Smith, Kauai Longitudinal Study — all 698 children born in 1955 on the Hawaiian island of Kauai, followed from the prenatal period to ages 1, 2, 10, 18, 32 and 40 (Overcoming the Odds, Cornell University Press, 1992; 'Risk, resilience, and recovery', Development and Psychopathology, 1993)", claim: "One of every three high-risk children (chronic poverty, perinatal stress, parental psychopathology, family discord) grew into a competent, caring adult — and adult adaptation depended increasingly on the quality of the child-rearing environment and the emotional support of family, friends, teachers and adult mentors. The longest-running evidence that a caring adult is a protective factor, not a bonus.", medium: "longitudinal study (40-year cohort)", confidence: "Strong", year: "1955–1993" }
    ],
